    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FuturoCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FuturoCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and futurocoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FuturoCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about FuturoCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FuturoCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FuturoCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FuturoCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a futurocoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FuturoCoin Core help message to get a list with possible FuturoCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FuturoCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FuturoCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("FuturoCoin Core"); // default title
    ...
    // Append title to "FuturoCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
