    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FuturoCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FuturoCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  futurocoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FuturoCoin Core is shutting down...") + "<br /><br />" +
