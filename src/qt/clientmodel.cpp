...
static void NotifyInstantSendFeeChanged(ClientModel *clientmodel)
{
    QMetaObject::invokeMethod(clientmodel, "instantSendFeeChanged", Qt::QueuedConnection);
}
...
void ClientModel::subscribeToCoreSignals()
{
    ...
    uiInterface.NotifyInstantSendFeeChanged.connect(boost::bind(NotifyInstantSendFeeChanged, this));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.NotifyInstantSendFeeChanged.disconnect(boost::bind(NotifyInstantSendFeeChanged, this));
}
